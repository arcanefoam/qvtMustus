 ...
 */
public class QVTtemplatePivotStandaloneSetup //implements ISetup
{
	private static Injector injector = null;
	
	public static void doSetup() {
		if (injector == null) {
			injector = new QVTtemplatePivotStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
	}
	...
	public Injector createInjectorAndDoEMFRegistration() {
		...
		if (!EPackage.Registry.INSTANCE.containsKey(QVTtemplatePackage.eNS_URI))
			EPackage.Registry.INSTANCE.put(QVTtemplatePackage.eNS_URI, QVTtemplatePackage.eINSTANCE);
