...
public class QVTbaseEVNodeCountImpl extends EvaluationVisitorImpl implements QVTbaseVisitor<Object> {
	 ...
	 */
	public QVTbaseEVNodeCountImpl( @NonNull Environment env,  @NonNull EvaluationEnvironment evalEnv, @NonNull DomainModelManager modelManager) {
		super(env, evalEnv, modelManager);
	}
	
	public QVTbaseEVNodeCountImpl(Environment env,
	...
	@Nullable
	public Value visitPredicate(@NonNull Predicate predicate) {
		// TODO Add visit function or decide if it should never be implemented
		predicateCount ++;
