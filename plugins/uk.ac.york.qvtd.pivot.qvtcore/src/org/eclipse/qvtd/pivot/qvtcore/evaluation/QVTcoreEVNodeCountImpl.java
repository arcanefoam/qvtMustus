...
import org.eclipse.qvtd.pivot.qvtbase.evaluation.QVTbaseEVNodeCountImpl;
...
public class QVTcoreEVNodeCountImpl extends QVTbaseEVNodeCountImpl implements QVTcoreVisitor<Object> {
	...
	public QVTcoreEVNodeCountImpl(Environment env,
	...
	public Object visitBottomPattern(BottomPattern bottomPattern) {
		...
		for(Variable var : bottomPattern.getVariable()) {
			if(var != null) {
				// TODO how to initialise variables? I guess in this case we will
