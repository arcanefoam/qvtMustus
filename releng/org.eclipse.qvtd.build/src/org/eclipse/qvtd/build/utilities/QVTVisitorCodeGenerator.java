...
import org.eclipse.qvtd.build.acceleo.GenerateQVTVisitors;
 ...
 */
public class QVTVisitorCodeGenerator extends AbstractWorkflowComponent
{
	...
	public void invokeInternal(WorkflowContext ctx, ProgressMonitor arg1, Issues issues) {
		...
		try {
			...
			GenerateQVTVisitors acceleo = new GenerateQVTVisitors(ecoreModel, folder, arguments);
