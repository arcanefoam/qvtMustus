 ...
 * </copyright>
 *
 * $Id: RelationalTransformationImpl.java,v 1.1 2008/07/23 09:46:09 qglineur Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTRelation.impl.RelationalTransformationImpl#getOwnedKey <em>Owned Key</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationalTransformationImpl extends TransformationImpl implements RelationalTransformation {
	...
	public Relation getRelation(String name) {
		...
		for (Rule rule : getRule()) {
			if ((rule instanceof Relation) && name.equals(rule.getName()))
				return (Relation) rule;
		}
		Transformation extended = getExtends();
		if (extended instanceof RelationalTransformation)
			return ((RelationalTransformation) extended).getRelation(name);
		return null;
	}
