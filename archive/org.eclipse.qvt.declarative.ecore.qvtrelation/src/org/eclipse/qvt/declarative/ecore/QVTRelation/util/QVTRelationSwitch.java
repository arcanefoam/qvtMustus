	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QVTRelationPackage.RELATION_CALL_EXP: {
				...
				if (result == null) result = caseVisitable(relationCallExp);
				if (result == null) result = caseASTNode(relationCallExp);
				if (result == null) result = caseEModelElement(relationCallExp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTRelationPackage.RELATIONAL_TRANSFORMATION: {
				...
				if (result == null) result = caseEClass(relationalTransformation);
				if (result == null) result = caseEPackage(relationalTransformation);
				if (result == null) result = caseEClassifier(relationalTransformation);
