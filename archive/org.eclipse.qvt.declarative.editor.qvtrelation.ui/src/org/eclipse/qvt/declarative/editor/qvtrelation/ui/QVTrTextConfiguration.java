 ...
 * </copyright>
 *
 * $Id: QVTrTextConfiguration.java,v 1.3 2008/08/18 07:57:37 ewillink Exp $
 */
...
public class QVTrTextConfiguration extends QVTTextSourceViewerConfiguration {
	private TextDoubleClickStrategy doubleClickStrategy;
	private QVTrTextDefaultContentScanner scanner = null;
	private TextColorManager colorManager;

	public QVTrTextConfiguration(TextColorManager colorManager) {
	...
	protected QVTrTextDefaultContentScanner getDefaultContentTypeScanner() {
		if (scanner == null) {
			scanner = new QVTrTextDefaultContentScanner(colorManager);
