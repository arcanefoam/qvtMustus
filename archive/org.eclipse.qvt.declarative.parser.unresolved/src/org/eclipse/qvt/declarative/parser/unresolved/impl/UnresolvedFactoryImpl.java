 ...
 * </copyright>
 *
 * $Id: UnresolvedFactoryImpl.java,v 1.1 2008/07/23 10:09:21 qglineur Exp $
 */
...
public class UnresolvedFactoryImpl extends EFactoryImpl implements UnresolvedFactory {
	...
	public static UnresolvedFactory init() {
		try {
			UnresolvedFactory theUnresolvedFactory = (UnresolvedFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/qvt/1.0/Unresolved"); 
