 ...
 * </copyright>
 *
 * $Id: WhenCSImpl.java,v 1.1 2008/08/18 07:55:54 ewillink Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.qvt.declarative.parser.qvtrelation.cst.impl.WhenCSImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WhenCSImpl extends CSTNodeImpl implements WhenCS {
	/**
	...
	protected EClass eStaticClass() {
		return QVTrCSTPackage.Literals.WHEN_CS;
	}
	...
	public EList<OCLExpressionCS> getExpr() {
		if (expr == null) {
			expr = new EObjectContainmentEList<OCLExpressionCS>(OCLExpressionCS.class, this, QVTrCSTPackage.WHEN_CS__EXPR);
		}
		return expr;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case QVTrCSTPackage.WHEN_CS__EXPR:
