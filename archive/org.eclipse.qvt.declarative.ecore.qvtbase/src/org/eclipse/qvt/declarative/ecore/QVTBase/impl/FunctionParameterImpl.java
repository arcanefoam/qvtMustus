 ...
 * </copyright>
 *
 * $Id: FunctionParameterImpl.java,v 1.4 2009/12/19 13:33:19 ewillink Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTBase.impl.FunctionParameterImpl#getStartPosition <em>Start Position</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTBase.impl.FunctionParameterImpl#getEndPosition <em>End Position</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTBase.impl.FunctionParameterImpl#getTypeStartPosition <em>Type Start Position</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTBase.impl.FunctionParameterImpl#getTypeEndPosition <em>Type End Position</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTBase.impl.FunctionParameterImpl#getInitExpression <em>Init Expression</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTBase.impl.FunctionParameterImpl#getRepresentedParameter <em>Represented Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionParameterImpl extends EParameterImpl implements FunctionParameter {
	...
	public void setStartPosition(int newStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTBasePackage.FUNCTION_PARAMETER__START_POSITION, oldStartPosition, startPosition));
	}
	...
	public void setEndPosition(int newEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTBasePackage.FUNCTION_PARAMETER__END_POSITION, oldEndPosition, endPosition));
	}
	...
	public void setTypeStartPosition(int newTypeStartPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTBasePackage.FUNCTION_PARAMETER__TYPE_START_POSITION, oldTypeStartPosition, typeStartPosition));
	}
	...
	public void setTypeEndPosition(int newTypeEndPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QVTBasePackage.FUNCTION_PARAMETER__TYPE_END_POSITION, oldTypeEndPosition, typeEndPosition));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ASTNode.class) {
			switch (derivedFeatureID) {
				case QVTBasePackage.FUNCTION_PARAMETER__START_POSITION: return UtilitiesPackage.AST_NODE__START_POSITION;
				case QVTBasePackage.FUNCTION_PARAMETER__END_POSITION: return UtilitiesPackage.AST_NODE__END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == TypedASTNode.class) {
			switch (derivedFeatureID) {
				case QVTBasePackage.FUNCTION_PARAMETER__TYPE_START_POSITION: return UtilitiesPackage.TYPED_AST_NODE__TYPE_START_POSITION;
				case QVTBasePackage.FUNCTION_PARAMETER__TYPE_END_POSITION: return UtilitiesPackage.TYPED_AST_NODE__TYPE_END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == Variable.class) {
			switch (derivedFeatureID) {
				case QVTBasePackage.FUNCTION_PARAMETER__INIT_EXPRESSION: return ExpressionsPackage.VARIABLE__INIT_EXPRESSION;
				case QVTBasePackage.FUNCTION_PARAMETER__REPRESENTED_PARAMETER: return ExpressionsPackage.VARIABLE__REPRESENTED_PARAMETER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == ASTNode.class) {
			switch (baseFeatureID) {
				case UtilitiesPackage.AST_NODE__START_POSITION: return QVTBasePackage.FUNCTION_PARAMETER__START_POSITION;
				case UtilitiesPackage.AST_NODE__END_POSITION: return QVTBasePackage.FUNCTION_PARAMETER__END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == TypedASTNode.class) {
			switch (baseFeatureID) {
				case UtilitiesPackage.TYPED_AST_NODE__TYPE_START_POSITION: return QVTBasePackage.FUNCTION_PARAMETER__TYPE_START_POSITION;
				case UtilitiesPackage.TYPED_AST_NODE__TYPE_END_POSITION: return QVTBasePackage.FUNCTION_PARAMETER__TYPE_END_POSITION;
				default: return -1;
			}
		}
		if (baseClass == Variable.class) {
			switch (baseFeatureID) {
				case ExpressionsPackage.VARIABLE__INIT_EXPRESSION: return QVTBasePackage.FUNCTION_PARAMETER__INIT_EXPRESSION;
				case ExpressionsPackage.VARIABLE__REPRESENTED_PARAMETER: return QVTBasePackage.FUNCTION_PARAMETER__REPRESENTED_PARAMETER;
				default: return -1;
			}
		}
		if (baseClass == org.eclipse.ocl.ecore.Variable.class) {
