	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QVTBasePackage.FUNCTION_PARAMETER: {
				...
				if (result == null) result = caseTypedASTNode(functionParameter);
				if (result == null) result = caseEModelElement(functionParameter);
				if (result == null) result = caseASTNode(functionParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case QVTBasePackage.TRANSFORMATION: {
				...
				if (result == null) result = caseEClass(transformation);
				if (result == null) result = caseEPackage(transformation);
				if (result == null) result = caseEClassifier(transformation);
