...
public abstract class CSTRootEnvironment<E extends ICSTNodeEnvironment, CST extends CSTNode> extends CSTNodeEnvironment<E, XMIResource, CST> implements ICSTRootEnvironment
{
	...
	protected CSTRootEnvironment(ICSTFileEnvironment fileEnvironment, XMIResource astNode, CST cstNode) {
