...
public class QVTCSTSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QVTCSTPackage.IDENTIFIED_CS: {
				...
				if (result == null) result = caseCSTNode(identifiedCS);
				if (result == null) result = caseIHasName(identifiedCS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCSTPackage.IDENTIFIER_CS: {
				IdentifierCS identifierCS = (IdentifierCS)theEObject;
				T result = caseIdentifierCS(identifierCS);
				if (result == null) result = caseCSTNode(identifierCS);
				if (result == null) result = caseIHasName(identifierCS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Identifier CS</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Identifier CS</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
