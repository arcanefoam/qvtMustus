 ...
 *******************************************************************************/
package org.eclipse.qvt.declarative.parser.plugin;
...
public final class QVTParserPlugin extends EMFPlugin
{
	// The plug-in ID
	public static final String PLUGIN_ID = QVTParserPlugin.class.getPackage().getName();
	public static final QVTParserPlugin INSTANCE = new QVTParserPlugin();
