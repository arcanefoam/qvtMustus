...
public class QVTcMultiEditorTests extends QVTcEditorTestCase
{
	...
	public void testTwoEditorsDoAndUndo() throws CoreException, ExecutionException, BadLocationException {
		...
		final String contents3A = "formation txA {}\n";
		final String contents1B = "tr";
		final String contents2B = " ";
		final String contents3B = "ansformation txB {}\n";
		final String contentsA = contents1A + contents3A;
		final String contentsB = contents1B + contents3B;
		final String testFileNameA = getName() + ".A.qvtc";
		final String testFileNameB = getName() + ".B.qvtc";
		final String pageTitle = "QVT core Text";
	...
	public void testEditQvtCoreAsEqvtCore() throws CoreException, ExecutionException, BadLocationException {
		final String contents =
			...
			"	xmlns:eqvtcore=\"http://www.eclipse.org/gmt/umlx/EQVTcore\"\n" +
			"	xmlns:ocl.ecore=\"http://www.eclipse.org/ocl/1.1.0/Ecore\"\n" +
			"	xmi:id=\"ast0\" name=\"umlRdbms\"/>\n";
		IFile file = createFile(getName() + ".qvtcore", contents);
	...
	public void testEditNotEqvtCore() throws CoreException, ExecutionException, BadLocationException {
		final String contents =
			...
			"</emp:Company>\n";
		IFile file = createFile(getName() + ".eqvtcore", contents);
	...
	public void testEditNotQvtCore() throws CoreException, ExecutionException, BadLocationException {
		final String contents =
			"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
			"<emp:Company xmi:version=\"2.0\" xmlns:xmi=\"http://www.omg.org/XMI\" xmlns:emp=\"http://www.eclipse.org/OCL/examples/codegen/employee\">\n" +
			"  <employees empID=\"99\" name=\"e1\"/>\n" +
