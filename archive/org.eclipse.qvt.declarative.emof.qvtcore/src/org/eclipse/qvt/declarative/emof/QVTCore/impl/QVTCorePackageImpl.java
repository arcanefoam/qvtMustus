 ...
 * </copyright>
 *
 * $Id: QVTCorePackageImpl.java,v 1.2 2009/11/19 10:33:46 ewillink Exp $
 */
...
import org.eclipse.qvt.declarative.emof.QVTCore.CoreDomain;
import org.eclipse.qvt.declarative.emof.QVTCore.CorePattern;
...
import org.eclipse.qvt.declarative.emof.QVTCore.Mapping;
import org.eclipse.qvt.declarative.emof.QVTCore.PropertyAssignment;
import org.eclipse.qvt.declarative.emof.QVTCore.QVTCoreFactory;
...
import org.eclipse.qvt.declarative.emof.QVTCore.VariableAssignment;
...
public class QVTCorePackageImpl extends EPackageImpl implements QVTCorePackage {
	 ...
	 * @see org.eclipse.qvt.declarative.emof.QVTCore.QVTCorePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAssignment_IsDefault(), theEMOFPackage.getBoolean(), "isDefault", null, 0, 1, Assignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCorePattern_Variable(), theEssentialOCLPackage.getVariable(), null, "variable", null, 0, -1, CorePattern.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getPropertyAssignment_SlotExpression(), theEssentialOCLPackage.getOclExpression(), null, "slotExpression", null, 1, 1, PropertyAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
