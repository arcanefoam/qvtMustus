 ...
 *
 * $Id: ProblemsFactoryImpl.java,v 1.2 2008/10/09 17:21:15 qglineur Exp $
 */
...
public class ProblemsFactoryImpl extends EFactoryImpl implements ProblemsFactory {
	...
	public static ProblemsFactory init() {
		try {
			ProblemsFactory theProblemsFactory = (ProblemsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/qvt/2008/atlvm/problems"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ProblemsPackage.PROBLEM: return createProblem();
			default:
