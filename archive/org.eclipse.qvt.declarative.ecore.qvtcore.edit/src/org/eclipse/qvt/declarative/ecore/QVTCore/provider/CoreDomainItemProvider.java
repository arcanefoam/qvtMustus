 ...
 * </copyright>
 *
 * $Id: CoreDomainItemProvider.java,v 1.1 2008/07/23 09:44:16 qglineur Exp $
 */
...
import org.eclipse.qvt.declarative.ecore.QVTBase.provider.DomainItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.qvt.declarative.ecore.QVTCore.CoreDomain} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreDomainItemProvider
	 ...
	 * @generated
	 */
	public CoreDomainItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CoreDomain"));
	}
	...
	public String getText(Object object) {
		String label = ((CoreDomain)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CoreDomain_type") :
			getString("_UI_CoreDomain_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CoreDomain.class)) {
