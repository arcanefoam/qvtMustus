	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QVTTemplatePackage.TEMPLATE_EXP: {
				...
				if (result == null) result = caseENamedElement(templateExp);
				if (result == null) result = caseTypedElement(templateExp);
				if (result == null) result = caseVisitable(templateExp);
				if (result == null) result = caseASTNode(templateExp);
				if (result == null) result = caseEModelElement(templateExp);
			...
			case QVTTemplatePackage.OBJECT_TEMPLATE_EXP: {
				...
				if (result == null) result = caseENamedElement(objectTemplateExp);
				if (result == null) result = caseTypedElement(objectTemplateExp);
				if (result == null) result = caseVisitable(objectTemplateExp);
				if (result == null) result = caseASTNode(objectTemplateExp);
				if (result == null) result = caseEModelElement(objectTemplateExp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTTemplatePackage.COLLECTION_TEMPLATE_EXP: {
				...
				if (result == null) result = caseENamedElement(collectionTemplateExp);
				if (result == null) result = caseTypedElement(collectionTemplateExp);
				if (result == null) result = caseVisitable(collectionTemplateExp);
				if (result == null) result = caseASTNode(collectionTemplateExp);
				if (result == null) result = caseEModelElement(collectionTemplateExp);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTTemplatePackage.PROPERTY_TEMPLATE_ITEM: {
				...
				if (result == null) result = caseEModelElement(propertyTemplateItem);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
