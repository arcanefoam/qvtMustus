...
import org.eclipse.qvt.declarative.editor.ui.text.TextPageFactoryRegistry;
import org.eclipse.qvt.declarative.editor.ui.xml.EcoreXMLPageFactory;

public final class OpenTextSheetAction extends AbstractObjectActionDelegate
{
		...
		if (selection instanceof IStructuredSelection) {
			for (Iterator<?> it = ((IStructuredSelection) selection).iterator(); it.hasNext(); ) {
				...
				if ((resource != null) && (targetPart instanceof PagedEditor)) {
					...
					TextPageFactoryRegistry pageFactoryRegistry = pagedEditor.getPageFactoryRegistry(TextPageFactoryRegistry.class);
					if (pageFactoryRegistry != null)
						pageFactoryRegistry.createPageFor(pagedEditor, resource, null);
				}
			}
		}
	}
