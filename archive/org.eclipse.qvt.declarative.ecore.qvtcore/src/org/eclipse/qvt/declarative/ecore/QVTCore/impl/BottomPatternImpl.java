 ...
 * </copyright>
 *
 * $Id: BottomPatternImpl.java,v 1.2 2009/02/17 21:44:24 ewillink Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTCore.impl.BottomPatternImpl#getArea <em>Area</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTCore.impl.BottomPatternImpl#getAssignment <em>Assignment</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTCore.impl.BottomPatternImpl#getEnforcementOperation <em>Enforcement Operation</em>}</li>
 *   <li>{@link org.eclipse.qvt.declarative.ecore.QVTCore.impl.BottomPatternImpl#getRealizedVariable <em>Realized Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BottomPatternImpl extends CorePatternImpl implements BottomPattern {
	...
	protected void addAllPatternVariables(UniqueEList<Variable> allVariables, Area area) {
		super.addAllPatternVariables(allVariables, area);
		BottomPattern bottomPattern = area.getBottomPattern();
		if (bottomPattern != null) {
			allVariables.addAll(bottomPattern.getVariable());
			allVariables.addAll(bottomPattern.getRealizedVariable());
		}
	}
