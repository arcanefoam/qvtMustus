	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case QVTCorePackage.ASSIGNMENT: {
				...
				if (result == null) result = caseEModelElement(assignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.BOTTOM_PATTERN: {
				...
				if (result == null) result = caseEModelElement(bottomPattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.CORE_DOMAIN: {
				...
				if (result == null) result = caseENamedElement(coreDomain);
				if (result == null) result = caseEModelElement(coreDomain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.CORE_PATTERN: {
				...
				if (result == null) result = caseEModelElement(corePattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.ENFORCEMENT_OPERATION: {
				...
				if (result == null) result = caseEModelElement(enforcementOperation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.GUARD_PATTERN: {
				...
				if (result == null) result = caseEModelElement(guardPattern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.MAPPING: {
				...
				if (result == null) result = caseENamedElement(mapping);
			...
			case QVTCorePackage.PROPERTY_ASSIGNMENT: {
				...
				if (result == null) result = caseEModelElement(propertyAssignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.REALIZED_VARIABLE: {
				...
				if (result == null) result = caseTypedASTNode(realizedVariable);
				if (result == null) result = caseEModelElement(realizedVariable);
				if (result == null) result = caseASTNode(realizedVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QVTCorePackage.VARIABLE_ASSIGNMENT: {
				...
				if (result == null) result = caseEModelElement(variableAssignment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
