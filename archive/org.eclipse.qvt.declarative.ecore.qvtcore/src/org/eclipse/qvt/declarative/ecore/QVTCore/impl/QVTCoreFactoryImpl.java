 ...
 * </copyright>
 *
 * $Id: QVTCoreFactoryImpl.java,v 1.1 2008/07/23 09:43:25 qglineur Exp $
 */
...
public class QVTCoreFactoryImpl extends EFactoryImpl implements QVTCoreFactory {
	...
	public static QVTCoreFactory init() {
		try {
			QVTCoreFactory theQVTCoreFactory = (QVTCoreFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/qvt/1.0/QVTCore"); 
